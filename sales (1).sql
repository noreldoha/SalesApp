...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2025 at 01:52 PM
...
(1, 'admin', 'test@gmail.com', 'admin', '$2y$10$q6xtz/5vQNV2GZEDqeuNVee.Gp.M0NctdhdKGU8ygajm7SaNfwFQi', '2025-02-10 20:57:58', '2025-02-10 20:57:58', NULL, NULL, 1);
...
CREATE TABLE `admin_panel_settings` (
  ...
  `general_alert` varchar(150) NOT NULL,
...
(1, 'الحوهرة المتحدة للمصاعد', '', 1, '', 'الشوقية مكة', '0125364666', 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1);
